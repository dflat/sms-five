  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
     	...
     	<div class="modal-location-button" data-destination="All Paper Invoices">
       		<a href="{{route('invoice.paper.index')}}" class="glyphicon glyphicon-list"></a>
	...
	<div class="panel panel-default">
		<div class="panel-heading clearfix">
			<div class="float-left">
				<h4>
					<strong>Paper Invoice # {{$invoice->invoice_no}}</strong>
			...
			<div class="invoice-edit-button float-right">
				<a href="{{route('invoice.paper.edit', ['id'=>$invoice->invoice_no,'action'=>'return'])}}" class="glyphicon glyphicon-minus-sign"></a>
			</div>
		</div>
