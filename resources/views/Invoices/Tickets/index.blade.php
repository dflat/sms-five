	...
	<div id="invoice-list" class="width-squeeze float-left">
		<div class="list-group">
			...
			@foreach($invoices as $invoice)
				...
				<a href="{{route('invoice.tickets.show', $invoice->invoice_no)}}" class="list-group-item list-group-item-success">
				@else
	  			<a href="{{route('invoice.tickets.show', $invoice->invoice_no)}}" class="list-group-item">
	  			@endif
	  				<div class="row">
