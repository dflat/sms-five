	...
	<div class="row" ng-controller="InvoicesController">
		<div class="container inspect">
			<div class="row filterInputs">
				...
				<div class="col-md-2">
					<input type="text" placeholder="Ticket" ng-model="search.ticket_name" class="form-control">
				</div>
				<div class="col-md-1">
			...
			<ul class="list-group">
				...
				<div class="all-results" ng-click="increaseLimit()">
							...
							<a href="/invoice/tickets/<%invoice_line.invoice_no%>" class="list-group-item" ng-repeat="invoice_line in filteredInvoiceLines = (invoice_lines | filter:search | limitTo:limit)">
