...
class ApiTicketInvoicesController extends Controller {
	...
	public function index()
	{
		...
		$invoice_lines = 
            ...
            ->join('ticket_invoices', 'ticket_invoices.id', '=', 'line_items.ticket_invoice_id')
            ...
            ->select(DB::raw('ticket_invoices.id as invoice_no, tickets.name as ticket_name, tickets.form as form_no, inventory.serial as serial_no, organizations.name as sold_to, line_items.sale_price as sale_price, line_items.created_at as sale_date'))
            //->groupBy('ticket_id')
